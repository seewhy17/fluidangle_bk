export default function contactTemplate(params, baseUrl) {
  ...
  <table style="width:100%;margin-bottom:1rem;border-spacing:2px;border-color:grey;">
    <tbody style="text-align:left;">
      <tr>
      <th style="color: #fff;background-color: #3b3b3b;border-color: #454d55;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: .75rem;border-top: 1px solid #dee2e6;border-collapse: collapse;">Name:</th>
      ...
      <tr>
        <th style="color: #fff;background-color: #3b3b3b;border-color: #454d55;vertical-align: bottom;border-bottom: 2px solid #dee2e6;padding: .75rem;border-top: 1px solid #dee2e6;border-collapse: collapse;">Project</th>
        <td style="padding: .75rem;vertical-align: top;border-top: 1px solid #dee2e6;border-collapse:collapse;">${params.project}</td>
      </tr>
      <tr>
  ...
  <p style="text-align: center">This mail was sent from <a href="${baseUrl}">Fluidangle Website</a></p>
</div>`
}
