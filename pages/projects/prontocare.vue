      ...
      <section class="banner-grid">
        <div class="content">
          <div class="title-block center-align">
            <h1 class="title">
              <img src="/img/Image 15.png" alt="Prontocare">
            </h1>
            <p class="">
            </p>
            <div class="image-part flex">
              <img src="/img/custom/Screenshot from 2019-06-23 16:49:23.png" alt="">
            </div>
          </div>
        </div>
      </section>
    ...
    <div class="container project-container">
      ...
      <div class="gallery">
        <div class="main-image flex dir-column list">
          <div class="image flex">
            <img src="/img/custom/Screenshot from 2019-06-23 17:06:42.png" alt="">
          </div>
        ...
        <div class="other-images grid equal-two">
          <div class="image">
            <img src="/img/custom/Screenshot from 2019-06-23 17:07:14.png" alt="">
          </div>
          <div class="image">
            <img src="/img/custom/Screenshot from 2019-06-23 17:07:34.png" alt="">
          </div>
        </div>
      </div>
      <div class="other-features">
        <div class="header">
          ...
          <div class="image-part flex list">
            <img src="/img/custom/Screenshot from 2019-06-23 17:02:08.png" alt="">
          </div>
        </div>
      </div>
    </div>
